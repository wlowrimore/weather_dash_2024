...
import CityStateCountryForm from "../forms/CityStateCountryForm";

const CurrentWeather = ({ weatherData, city, state, currentTimeOfDay, onNewSearch }) => {
  console.log("Current Time in CurrentWeather:", currentTimeOfDay);

  return (
    <>
      {/* Display Current Time and New Search Icon */}
      <div onClick={onNewSearch} className='xl:w-[12rem] xl:py-2 xl:px-3 fixed z-10 right-0 top-0 bg-gray-900/30 text-white rounded-l-full xl:rounded-l-lg xl:gap-2 flex items-center px-2 cursor-pointer'>
        <Image
          src={NewSearchIcon}
          alt="New Search"
          width={16}
                ...
                <div className='mx-6 xl:w-1/2 xl:bg-white/40 xl:rounded-lg xl:shadow-lg shadow-neutral-600'>
                  ...
                  <div className="space-y-3 mb-2 p-4 flex flex-col">
                    ...
                    <div className="flex flex-col items-center bg-blue-900/20 rounded-lg shadow-sm shadow-neutral-500 py-4 px-3">
                      <p className="text-2xl font-bold text-white xl:text-gray-800 pb-2">High / Low</p>
                    ...
                    <div className="mb-2 flex flex-col">
                      <div className="flex justify-center gap-4">
                        <div className="w-full flex flex-col items-center bg-blue-900/20 rounded-lg shadow-sm shadow-neutral-500 py-4 px-3">
                          <p className="text-xl font-bold text-white xl:text-gray-800 pb-2">Humidity</p>
                        ...
                        {weatherData?.wind && (
                          <div className="w-full flex flex-col items-center bg-blue-900/20 rounded-lg shadow-sm shadow-neutral-500 py-4 px-3">
                            <p className="text-xl font-bold text-white xl:text-gray-800 pb-2">Wind</p>
                            <p className="text-2xl text-neutral-600 font-semibold border px-3 py-1 rounded-lg bg-white/70">
